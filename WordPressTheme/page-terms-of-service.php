...
<section class="sub-mv js-mv">
    ...
    <source media="(min-width: 768px)" srcset="./assets/images/common/sitemap-mv-pc.jpg">
    <img src="./assets/images/common/sitemap-mv-sp.jpg" alt="サブメインビュー">
    </picture>
</section>
...
<section class="privacy layout-page-top">
    ...
    <h2 class="privacy__title">利用規約</h2>
    <div class="privacy__content">
        <p class="privacy__message">以下は、Webサイトで使用する一般的な利用規約の例です。</p><br>
