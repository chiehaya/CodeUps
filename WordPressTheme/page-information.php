...
<section class="sub-mv js-mv">
    ...
    <source media="(min-width: 768px)" srcset="./assets/images/common/info-mv-pc.jpg">
    <img src="./assets/images/common/info-mv-sp.jpg" alt="サブメインビュー">
    </picture>
</section>
...
<section class="info-page layout-page-top">
    ...
    <div class="info-page__contents" id="info-lisence">
        ...
        <img src="./assets/images/common/license.jpg" alt="ライセンス講習">
        </div>
    </div>
    <div class="info-page__contents" id="info-fun-diving">
        ...
        <div class="info-page__img">
        <img src="./assets/images/common/fundiving.jpg" alt="ファンダイビング">
        </div>
    </div>
    <div class="info-page__contents" id="info-diving">
        ...
        <div class="info-page__img">
        <img src="./assets/images/common/diving.jpg" alt="体験ダイビング">
        </div>
    </div>
    </div>
</section>
